      ...
      >
        <div className="max-w-6xl mx-auto space-y-8 sm:space-y-10">
          ...
          <div className="flex items-center justify-center gap-2 flex-wrap">
            <button
              className="px-4 py-2 rounded-full text-xs sm:text-sm font-bold transition-all bg-[#e35300] text-white shadow-md"
              data-sd-filter="all"
              aria-pressed="true"
            >सभी (All Inspirations)</button>
            <button
              className="px-4 py-2 rounded-full text-xs sm:text-sm font-bold transition-all bg-white text-slate-700 border border-slate-200 hover:bg-saffron-50"
              data-sd-filter="saints"
              aria-pressed="false"
            >संत एवं धर्माचार्य</button>
            <button
              className="px-4 py-2 rounded-full text-xs sm:text-sm font-bold transition-all bg-white text-slate-700 border border-slate-200 hover:bg-saffron-50"
              data-sd-filter="justice"
              aria-pressed="false"
            >न्याय एवं वैचारिक नेतृत्व</button>
            <button
              className="px-4 py-2 rounded-full text-xs sm:text-sm font-bold transition-all bg-white text-slate-700 border border-slate-200 hover:bg-saffron-50"
              data-sd-filter="nation"
              aria-pressed="false"
            >राष्ट्र एवं जननेतृत्व</button>
          </div>
          <div className="sd-ppl-meta">
            <span className="sd-ppl-count" data-sd-count="">14 प्रेरणा स्रोत</span>
          </div>
          <div className="sd-ppl" data-sd-ppl="">
            <button type="button" className="sd-ppl__nav sd-ppl__nav--prev" aria-label="Previous">
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <path d="m15 18-6-6 6-6"></path>
              </svg>
            </button>
            <div className="sd-ppl__track">
              <div
                data-sd-cat="saints"
              ...
              >
                <div
                  className="relative aspect-[4/4.5] bg-gradient-to-br from-amber-50 to-orange-100 overflow-hidden shrink-0 flex items-center justify-center"
                >
                  <img
                    src="/people/ram_bhadra_charya.jpeg"
                    alt="जगद्गुरु रामभद्राचार्य जी महाराज"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >जगद्गुरु रामभद्राचार्य जी महाराज</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    प्रख्यात संत, धर्माचार्य, श्रीराम भक्ति, भारतीय संस्कृति एवं सनातन चेतना के संरक्षण, संवर्धन और जागरण के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/dhirendra_shashtry.jpeg"
                    alt="धीरेंद्र कृष्ण शास्त्री जी महाराज"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >धीरेंद्र कृष्ण शास्त्री जी महाराज</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    सनातन जागरण, हिन्दू एकता एवं धर्म-संस्कृति के संरक्षण के लिए समर्पित आध्यात्मिक प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/devki_nandan.jpeg"
                    alt="देवकीनंदन ठाकुर जी महाराज"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >देवकीनंदन ठाकुर जी महाराज</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    कथावाचक, आध्यात्मिक वक्ता एवं सनातन धर्म के प्रचार-प्रसार तथा जनजागरण के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/govind_devgiri.jpeg"
                    alt="स्वामी गोविंद देव गिरी जी महाराज"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >स्वामी गोविंद देव गिरी जी महाराज</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    वैदिक परंपरा, धर्मशिक्षा, भारतीय संस्कृति एवं सनातन मूल्यों के संरक्षण और प्रसार के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div
                  className="relative aspect-[4/4.5] bg-gradient-to-br from-amber-50/90 via-orange-50/80 to-amber-100/90 p-1.5 border-b border-saffron-100 overflow-hidden shrink-0 flex items-center justify-center"
                >
                  <img
                    src="/people/hari_shankar_jain_and_vishnu_shankar_jain.jpeg"
                    alt="अधिवक्ता हरिशंकर जैन जी एवं अधिवक्ता विष्णु शंकर जैन जी"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >अधिवक्ता हरिशंकर जैन जी एवं अधिवक्ता विष्णु शंकर जैन जी</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    सनातन धर्म, धार्मिक अधिकारों एवं सांस्कृतिक विरासत के संरक्षण हेतु न्यायिक संघर्ष, वैचारिक प्रतिबद्धता और जनजागरण के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/ashwini_upadhyaya.jpeg"
                    alt="अधिवक्ता अश्विनी उपाध्याय जी"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >अधिवक्ता अश्विनी उपाध्याय जी</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    संवैधानिक मूल्यों, जनहित, समान नागरिक संहिता एवं राष्ट्रीय हित से जुड़े विषयों पर वैचारिक एवं न्यायिक प्रयासों के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/yogi_adithanath.jpeg"
                    alt="योगी आदित्यनाथ जी"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >योगी आदित्यनाथ जी</h4>
                    <p className="text-xs font-semibold text-saffron-700 mt-0.5">मुख्यमंत्री, उत्तर प्रदेश</p>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    हिन्दुत्व, सनातन संस्कृति, राष्ट्रधर्म, सुशासन एवं लोकसेवा के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/pushkar_singh_dhami.jpeg"
                    alt="पुष्कर सिंह धामी जी"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >पुष्कर सिंह धामी जी</h4>
                    <p className="text-xs font-semibold text-saffron-700 mt-0.5">मुख्यमंत्री, उत्तराखंड</p>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    सनातन संस्कृति, सांस्कृतिक विरासत के संरक्षण, सुशासन एवं जनसेवा के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/hemanta_biswa_sharma.jpeg"
                    alt="हिमंत बिस्व सरमा जी"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >हिमंत बिस्व सरमा जी</h4>
                    <p className="text-xs font-semibold text-saffron-700 mt-0.5">मुख्यमंत्री, असम</p>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">राष्ट्रीय एकता, सनातन संस्कृति, सुशासन एवं जनहित के प्रेरणास्रोत।</p>
                </div>
              </div>
              <div
                data-sd-cat="nation"
              ...
              >
                ...
                >
                  <img
                    src="/people/suvendu_adhikary.jpeg"
                    alt="सुवेन्दु अधिकारी जी"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >सुवेन्दु अधिकारी जी</h4>
                    <p className="text-xs font-semibold text-saffron-700 mt-0.5">जननेता, पश्चिम बंगाल</p>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">हिन्दुत्व, सनातन अस्मिता, राष्ट्रहित एवं जनसेवा के प्रेरणास्रोत।</p>
                </div>
              </div>
              <div
                data-sd-cat="nation"
              ...
              >
                ...
                >
                  <img
                    src="/people/bala_thackrey.jpeg"
                    alt="स्वर्गीय बालासाहेब ठाकरे जी"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >स्वर्गीय बालासाहेब ठाकरे जी</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    हिन्दुत्व, सनातन अस्मिता, सांस्कृतिक स्वाभिमान एवं राष्ट्रहित के लिए निर्भीक नेतृत्व के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/raja_bhaiya.jpeg"
                    alt="राजा भैया (रघुराज प्रताप सिंह जी)"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >राजा भैया (रघुराज प्रताप सिंह जी)</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    सनातन संस्कृति, सामाजिक समरसता, जनसेवा एवं भारतीय परंपराओं के संरक्षण के लिए समर्पित नेतृत्व के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >टी. राजा सिंह जी</h4>
                    <p className="text-xs font-semibold text-saffron-700 mt-0.5">विधायक, तेलंगाना</p>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    हिन्दुत्व, सनातन जागरण एवं धार्मिक-सांस्कृतिक संरक्षण के लिए समर्पित जननेतृत्व के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <img
                    src="/people/ashok_singhal.jpeg"
                    alt="स्वर्गीय अशोक सिंघल जी"
                    className="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-500"
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                ...
                <div className="p-4 flex flex-col flex-1 justify-between text-left space-y-2">
                  <div>
                    <h4
                      className="deva font-serif text-base font-bold text-gray-900 leading-snug group-hover:text-saffron-600 transition-colors"
                    >स्वर्गीय अशोक सिंघल जी</h4>
                  </div>
                  <p className="deva text-xs text-slate-600 leading-relaxed font-normal">
                    सनातन जागरण, श्रीराम जन्मभूमि आंदोलन, हिन्दुत्व एवं सांस्कृतिक राष्ट्रचेतना के लिए समर्पित संगठनात्मक नेतृत्व के प्रेरणास्रोत।
                  </p>
                </div>
              </div>
            </div>
            <button type="button" className="sd-ppl__nav sd-ppl__nav--next" aria-label="Next">
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <path d="m9 18 6-6-6-6"></path>
              </svg>
            </button>
