...
export default function ViewFundraisersPage() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="text-center mb-8">
            ...
            >
              ...
              <span className="text-[#FF6F00]">सक्रिय अभियान</span>
            </h1>
            <p className="text-[#FF6F00] font-bold text-xs sm:text-sm tracking-wider mb-4">
              सनातन धर्म, संस्कृति, गौ सेवा एवं मानव कल्याण हेतु चल रहे अभियानों में अपना योगदान दें।
            </p>
            <p
            ...
            >
              प्रत्येक अभियान 100% सत्यापित है। आपका छोटा सा योगदान किसी मंदिर के जिर्णोद्धार, गौ माता के भोजन या किसी निर्धन बालक की शिक्षा में बड़ी क्रांति ला सकता है।
            </p>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-10">
            <div className="rounded-2xl bg-white border border-[#FF6F00]/20 p-4 text-center shadow-sm">
              <div className="font-serif font-bold text-lg sm:text-xl text-[#FF6F00]">₹1.48 Crore+</div>
              <div className="font-bold text-xs text-[#0D1B2A] mt-1">Total Raised / कुल सहयोग</div>
              <div className="text-[11px] text-slate-500 mt-0.5">Directly Impacting Causes</div>
            </div>
            <div className="rounded-2xl bg-white border border-[#FF6F00]/20 p-4 text-center shadow-sm">
              <div className="font-serif font-bold text-lg sm:text-xl text-[#FF6F00]">12 Live Drives</div>
              <div className="font-bold text-xs text-[#0D1B2A] mt-1">Active Causes / सक्रिय अभियान</div>
              <div className="text-[11px] text-slate-500 mt-0.5">Verified &amp; Ongoing</div>
            </div>
            <div className="rounded-2xl bg-white border border-[#FF6F00]/20 p-4 text-center shadow-sm">
              <div className="font-serif font-bold text-lg sm:text-xl text-[#FF6F00]">18,400+ Donors</div>
              <div className="font-bold text-xs text-[#0D1B2A] mt-1">Verified Donors / दानदाता</div>
              <div className="text-[11px] text-slate-500 mt-0.5">Across India &amp; Abroad</div>
            </div>
            <div className="rounded-2xl bg-white border border-[#FF6F00]/20 p-4 text-center shadow-sm">
              <div className="font-serif font-bold text-lg sm:text-xl text-[#FF6F00]">0% Zero Fee</div>
              <div className="font-bold text-xs text-[#0D1B2A] mt-1">Platform Fee / प्लेटफॉर्म शुल्क</div>
              <div className="text-[11px] text-slate-500 mt-0.5">100% Goes To Cause</div>
            </div>
          </div>
          <div
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
                <div className="flex items-center gap-2">
                  ...
                  >
                    <option defaultValue="urgent" selected>Most Urgent First</option>
                    <option defaultValue="raised">Highest Raised</option>
                    <option defaultValue="newest">Ending Soon</option>
                  </select>
                </div>
                <Link
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed">
                    प्राचीन राम मंदिर जिर्णोद्धार, सुरक्षा दीवार निर्माण एवं प्रतिदिन 500 श्रद्धालुओं हेतु नि:शुल्क अन्नक्षेत्र सेवा।
                  </p>
                </div>
                <div className="space-y-2 pt-1 border-t border-slate-100">
                  <div className="flex items-center justify-between text-xs font-bold">
                    <span className="text-[#FF6F00]">
                      ₹3,85,000{' '}
                      <span className="text-slate-500 font-normal">raised</span>
                    </span>
                    <span className="text-slate-700">Goal: ₹5,00,000</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500">
                    ...
                    <span className="font-bold text-[#FF6F00]">77% Complete</span>
                  </div>
                </div>
                <button
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed">
                    150 असहाय गौवंश हेतु शीतकालीन शेड का निर्माण, हरा चारा एवं पशु चिकित्सा सुविधा।
                  </p>
                </div>
                <div className="space-y-2 pt-1 border-t border-slate-100">
                  <div className="flex items-center justify-between text-xs font-bold">
                    ...
                    <span className="text-slate-700">Goal: ₹3,00,000</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-[#FF8C00] to-[#FF6F00] rounded-full transition-all duration-500"
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500">
                    ...
                    <span className="font-bold text-[#FF6F00]">82% Complete</span>
                  </div>
                </div>
                <button
                  className="w-full h-11 rounded-xl bg-[#FF6F00] hover:bg-[#e06200] text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-md sd-btn sd-btn--donate-now"
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed">
                    सुदूर ग्रामीण क्षेत्रों में निःशुल्क नेत्र जांच, मोतियाबिंद ऑपरेशन एवं जीवन रक्षक दवाइयाँ।
                  </p>
                </div>
                <div className="space-y-2 pt-1 border-t border-slate-100">
                  <div className="flex items-center justify-between text-xs font-bold">
                    ...
                    <span className="text-slate-700">Goal: ₹2,00,000</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-[#FF8C00] to-[#FF6F00] rounded-full transition-all duration-500"
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500">
                    ...
                    <span className="font-bold text-[#FF6F00]">70% Complete</span>
                  </div>
                </div>
                <button
                  className="w-full h-11 rounded-xl bg-[#FF6F00] hover:bg-[#e06200] text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-md sd-btn sd-btn--donate-now"
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed">
                    100 निर्धन बटुकों हेतु वेद-पुराण शिक्षा, निःशुल्क आवास, भोजन एवं कम्प्यूटर शिक्षा लैब।
                  </p>
                </div>
                <div className="space-y-2 pt-1 border-t border-slate-100">
                  <div className="flex items-center justify-between text-xs font-bold">
                    ...
                    <span className="text-slate-700">Goal: ₹2,50,000</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-[#FF8C00] to-[#FF6F00] rounded-full transition-all duration-500"
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500">
                    ...
                    <span className="font-bold text-[#FF6F00]">72% Complete</span>
                  </div>
                </div>
                <button
                  className="w-full h-11 rounded-xl bg-[#FF6F00] hover:bg-[#e06200] text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-md sd-btn sd-btn--donate-now"
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed">
                    तीर्थ यात्रियों, साधु-संतों एवं असहाय जनों हेतु प्रतिदिन शुद्ध सात्विक महाप्रसाद वितरण।
                  </p>
                </div>
                <div className="space-y-2 pt-1 border-t border-slate-100">
                  <div className="flex items-center justify-between text-xs font-bold">
                    ...
                    <span className="text-slate-700">Goal: ₹4,00,000</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-[#FF8C00] to-[#FF6F00] rounded-full transition-all duration-500"
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500">
                    ...
                    <span className="font-bold text-[#FF6F00]">78% Complete</span>
                  </div>
                </div>
                <button
                  className="w-full h-11 rounded-xl bg-[#FF6F00] hover:bg-[#e06200] text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-md sd-btn sd-btn--donate-now"
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-600 line-clamp-2 leading-relaxed">
                    श्रीमद्भगवद्गीता एवं धार्मिक साहित्य का निःशुल्क वितरण तथा युवा जागृति शिविर।
                  </p>
                </div>
                <div className="space-y-2 pt-1 border-t border-slate-100">
                  <div className="flex items-center justify-between text-xs font-bold">
                    ...
                    <span className="text-slate-700">Goal: ₹1,50,000</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-[#FF8C00] to-[#FF6F00] rounded-full transition-all duration-500"
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500">
                    ...
                    <span className="font-bold text-[#FF6F00]">61% Complete</span>
                  </div>
                </div>
                <button
                  className="w-full h-11 rounded-xl bg-[#FF6F00] hover:bg-[#e06200] text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-md sd-btn sd-btn--donate-now"
          ...
          <div className="sd-fc">
            <div className="sd-fc-head">
              <p className="sd-fc-eyebrow">Where Your Support Goes</p>
              <h2 className="sd-fc-title">
                Campaign{' '}
                <span>Categories</span>
              </h2>
              <p className="sd-fc-sub deva">
                सेवा एवं सहायता, जनजागरण एवं मिशन, तथा भावी विकास — इन तीन दिशाओं में आपका सहयोग कार्य करता है।
              </p>
            </div>
            <div className="sd-fc-grid">
              <article className="sd-fc-card">
                ...
                <p className="sd-fc-en">Service &amp; Relief</p>
                <ul className="sd-fc-list deva">
                  <li>अन्न सेवा एवं भोजन सहायता</li>
                  <li>चिकित्सा एवं स्वास्थ्य सहायता</li>
                  <li>शिक्षा, संस्कार एवं बाल विकास सहायता</li>
                  <li>महिला सुरक्षा, सम्मान एवं सहायता अभियान</li>
                  <li>गौ सेवा एवं संरक्षण अभियान</li>
                  <li>आपदा राहत एवं मानव सहायता अभियान</li>
                </ul>
              </article>
              <article className="sd-fc-card">
                <span className="sd-fc-icon">
                ...
                <p className="sd-fc-en">Awareness &amp; Mission</p>
                <ul className="sd-fc-list deva">
                  <li>राष्ट्रीय जागरण एवं सनातन चेतना अभियान</li>
                  <li>सनातन संस्कृति संरक्षण एवं जनजागरण अभियान</li>
                  <li>फिल्म, संगीत एवं सांस्कृतिक जनजागरण कार्यक्रम</li>
                </ul>
              </article>
              <article className="sd-fc-card sd-fc-card--future">
                ...
                <p className="sd-fc-en">Upcoming Projects</p>
                <ul className="sd-fc-list deva">
                  <li>सनातनी सहायता केंद्र</li>
                  <li>सनातनी भोजनालय</li>
                  <li>सनातनी स्किल डेवलपमेंट सेंटर</li>
                  <li>सनातनी आश्रय धाम</li>
                  <li>सनातन गुरुकुल एवं संस्कार केंद्र</li>
                </ul>
          ...
          >
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-[#FF6F00]">Sanatan Community Welfare</span>
              <h2 className="font-serif text-2xl sm:text-3xl font-bold mt-1">Have a Cause in Mind? Start a Fundraiser</h2>
              <p className="text-xs sm:text-sm text-slate-300 mt-2 max-w-xl">
                यदि आप मंदिर जिर्णोद्धार, गौ सेवा या किसी सामाजिक कार्य हेतु धन जुटाना चाहते हैं, तो 0% प्लेटफॉर्म फीस के साथ अपना अभियान शुरू करें।
              </p>
            </div>
            <Link
