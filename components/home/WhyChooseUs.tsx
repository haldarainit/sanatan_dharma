      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="group flex flex-col items-center p-2 cursor-pointer">
            <div
              className="w-24 h-24 rounded-full border-2 border-[#d49b4b] group-hover:border-[6px] transition-all duration-200 ease-in-out flex items-center justify-center mb-7 group-hover:shadow-[0_0_15px_rgba(212,155,75,0.25)]"
            >
              <svg
                ...
                className="lucide lucide-search w-9 h-9 text-[#d49b4b] stroke-[1.8]"
              >
          ...
          <div className="group flex flex-col items-center p-2 cursor-pointer">
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-shield-check w-9 h-9 text-[#d49b4b] stroke-[1.8]"
              >
                <path
          ...
          <div className="group flex flex-col items-center p-2 cursor-pointer">
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-lock w-9 h-9 text-[#d49b4b] stroke-[1.8]"
              >
          ...
          <div className="group flex flex-col items-center p-2 cursor-pointer">
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-users w-9 h-9 text-[#d49b4b] stroke-[1.8]"
              >
