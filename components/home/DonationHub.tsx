...
export default function DonationHub({ text, images, upi = DEFAULT_UPI }: { text?: TextMap; images?: ImageMap; upi?: Upi }) {
  return (
      ...
      <div className="container-x">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-serif text-4xl sm:text-5xl font-bold leading-[1.05] text-gray-900 mb-1.5">
            Donation{' '}
            <span className="text-[#e35300]">{t(text, 'donation-hub-k1', "Hub")}</span>
          </h2>
          <p className="font-serif text-lg sm:text-xl font-bold text-gray-900 mb-1.5">{t(text, 'donation-hub-k2', "Online & Offline")}</p>
          <p className="deva text-slate-600 font-semibold text-[17px] sm:text-xl tracking-wide mb-4">{t(text, 'donation-hub-k3', "ऑनलाइन एवं प्रत्यक्ष सहयोग माध्यम।")}</p>
        </div>
        <div
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div className="text-xs font-extrabold uppercase tracking-wider text-[#0D1B2A]">{t(text, 'donation-hub-k4', "Choose Contribution Amount:")}</div>
            <div className="text-xs text-[#FF6F00] font-bold">{t(text, 'donation-hub-k5', "Selected: ₹501")}</div>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5">
            ...
            >
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k6', "₹51")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k7', "शुभ")}</div>
            </button>
            <button
              type="button"
              className="relative rounded-xl border px-2 py-2.5 text-center transition-all bg-white border-[#0D1B2A]/10 text-[#0D1B2A] hover:border-[#FF6F00]/40"
            >
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k8', "₹101")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k9', "मंगल")}</div>
            </button>
            <button
              type="button"
              className="relative rounded-xl border px-2 py-2.5 text-center transition-all bg-white border-[#0D1B2A]/10 text-[#0D1B2A] hover:border-[#FF6F00]/40"
            >
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k10', "₹301")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k11', "शुभारंभ")}</div>
            </button>
            <button
              type="button"
            ...
            >
              ...
              >Most Chosen</span>
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k12', "₹501")}</div>
              <div className="text-[10px] text-white/90">{t(text, 'donation-hub-k13', "एक परिवार का सहारा")}</div>
            </button>
            <button
              type="button"
              className="relative rounded-xl border px-2 py-2.5 text-center transition-all bg-white border-[#0D1B2A]/10 text-[#0D1B2A] hover:border-[#FF6F00]/40"
            >
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k14', "₹1,001")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k15', "शिक्षा सहयोग")}</div>
            </button>
            <button
              type="button"
              className="relative rounded-xl border px-2 py-2.5 text-center transition-all bg-white border-[#0D1B2A]/10 text-[#0D1B2A] hover:border-[#FF6F00]/40"
            >
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k16', "₹5,001")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k17', "विशेष सहायता")}</div>
            </button>
            <button
              type="button"
              className="relative rounded-xl border px-2 py-2.5 text-center transition-all bg-white border-[#0D1B2A]/10 text-[#0D1B2A] hover:border-[#FF6F00]/40"
            >
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k18', "₹11,000")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k19', "बड़ी मदद")}</div>
            </button>
            <button
              type="button"
              className="relative rounded-xl border px-2 py-2.5 text-center transition-all bg-white border-[#0D1B2A]/10 text-[#0D1B2A] hover:border-[#FF6F00]/40"
            >
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k20', "₹21,000")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k21', "महत्वपूर्ण योगदान")}</div>
            </button>
            <button
              type="button"
              className="relative rounded-xl border px-2 py-2.5 text-center transition-all bg-white border-[#0D1B2A]/10 text-[#0D1B2A] hover:border-[#FF6F00]/40"
            >
              <span
                className="absolute -top-2 left-1/2 -translate-x-1/2 whitespace-nowrap text-[9px] font-extrabold px-2 py-0.5 rounded-full bg-[#0D1B2A] text-white border shadow-sm"
              >VIP Supporter</span>
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k22', "₹51,000")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k23', "सम्मानित सहयोगी")}</div>
            </button>
            <button
              type="button"
              className="relative rounded-xl border px-2 py-2.5 text-center transition-all bg-white border-[#0D1B2A]/10 text-[#0D1B2A] hover:border-[#FF6F00]/40"
            >
              ...
              <div className="font-bold text-xs sm:text-sm">{t(text, 'donation-hub-k24', "₹1,00,001")}</div>
              <div className="text-[10px] text-[#0D1B2A]/60">{t(text, 'donation-hub-k25', "गर्व का योगदान")}</div>
            </button>
            <button
              type="button"
        ...
        >
          <div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-center gap-2 mb-1">
                  ...
                  <span className="font-sans font-bold text-xl tracking-tight text-gray-800">{t(text, 'donation-hub-k26', "Google Pay")}</span>
                </div>
                <h3
                ...
                <div className="text-[11px] text-gray-500 font-medium mt-0.5">{t(text, 'donation-hub-k27', "+91 97680 00666")}</div>
                <div
                  className="mt-2.5 mb-1 px-3 py-1 rounded-full bg-[#FFF4E6] border border-[#FF6F00]/30 flex items-center gap-1.5 text-[11.5px]"
                >
                  <span className="text-gray-600 font-medium">{t(text, 'donation-hub-k28', "Scan & pay:")}</span>
                  <span className="font-extrabold text-[#FF6F00]">{t(text, 'donation-hub-k29', "₹501")}</span>
                </div>
                ...
                <div className="mt-1 flex items-center justify-center gap-1.5">
                  <span className="text-[10.5px] font-semibold text-gray-500 uppercase">{t(text, 'donation-hub-k30', "UPI ID:")}</span>
                  <code className="text-[11.5px] font-bold font-mono text-gray-800">{upi.id}</code>
                  <button
                    type="button"
                ...
                <div className="w-full mt-3 pt-2.5 border-t border-gray-100 flex flex-col items-center gap-1.5">
                  ...
                  >
                    <span className="px-2 py-0.5 rounded bg-gray-100 border border-gray-200">{t(text, 'donation-hub-k32', "BHIM")}</span>
                    <span className="px-2 py-0.5 rounded bg-[#0A2540] text-white font-mono">{t(text, 'donation-hub-k33', "UPI")}</span>
                  </div>
                  <div className="flex flex-wrap items-center justify-center gap-1.5 text-[9px] font-bold">
                    <span className="px-1.5 py-0.5 rounded bg-blue-50 text-blue-600 border border-blue-100">{t(text, 'donation-hub-k34', "G Pay")}</span>
                    <span className="px-1.5 py-0.5 rounded bg-sky-50 text-sky-600 border border-sky-100">{t(text, 'donation-hub-k35', "Paytm")}</span>
                    <span className="px-1.5 py-0.5 rounded bg-purple-50 text-purple-600 border border-purple-100">{t(text, 'donation-hub-k36', "PhonePe")}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <span>{t(text, 'donation-hub-k37', "Open GPay / UPI App (₹501)")}</span>
            </a>
          ...
          >
            ...
            <ul className="space-y-3.5">
              <li className="flex items-center gap-3.5 text-sm sm:text-base text-slate-100 font-medium">
                ...
                <span>{t(text, 'donation-hub-k38', "Donation Receipt ईमेल एवं WhatsApp पर उपलब्ध कराई जाती है।")}</span>
              </li>
              <li className="flex items-center gap-3.5 text-sm sm:text-base text-slate-100 font-medium">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span>{t(text, 'donation-hub-k39', "80G Tax Benefit (लागू नियमों के अनुसार)।")}</span>
              </li>
              <li className="flex items-center gap-3.5 text-sm sm:text-base text-slate-100 font-medium">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span>
                  {t(text, 'donation-hub-k40', "प्रमुख सेवा कार्यों एवं अभियानों की जानकारी समय-समय पर साझा की जाती है।")}
                </span>
              </li>
              <li className="flex items-center gap-3.5 text-sm sm:text-base text-slate-100 font-medium">
                <svg
                ...
                <span>{t(text, 'donation-hub-k41', "महत्वपूर्ण रिपोर्ट एवं दस्तावेज उपलब्ध कराए जाते हैं।")}</span>
              </li>
            </ul>
          </div>
        </div>
